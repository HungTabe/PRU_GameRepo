...
public class PlayerMove : MonoBehaviour
{
    ...
    void Ship()
    {
        ...
        Sprite.rotation = Quaternion.Euler(0, 0, rb.linearVelocity.y * 2);
    }
    void Ball()
    {
    ...
    {
        rb.gravityScale = 0;
        rb.linearVelocity = new Vector2(0, SpeedValues[(int)CurrentSpeed] * (Input.GetKey(KeyCode.Space) ? 1 : -1) * Gravity);
    }
